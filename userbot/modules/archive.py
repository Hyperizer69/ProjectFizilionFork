...
""" a module for Zipping/Unzipping files. """
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            zipped = directory_name + ".zip"
            await mone.edit(f"Compressed successfully into `{zipped}`")
