...
@register(outgoing=True, pattern="^\{trg}notes$".format(trg=trgg))
...
@register(outgoing=True, pattern="^\{trg}clear (\w*)".format(trg=trgg))
...
@register(outgoing=True, pattern="^\{trg}save (\w*)".format(trg=trgg))
...
@register(outgoing=True, pattern="^\{trg}rmbotnotes (.*)".format(trg=trgg))
