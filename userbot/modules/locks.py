...
""" a module for locking specific types of messages. """
...
@register(outgoing=True, pattern="^\{trg}lock ?(.*)".format(trg=trgg))
...
@register(outgoing=True, pattern="^\{trg}unlock ?(.*)".format(trg=trgg))
