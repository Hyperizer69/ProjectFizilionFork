...
@register(outgoing=True, pattern="^\{trg}filter (.*)".format(trg=trgg))
...
@register(outgoing=True, pattern="^\{trg}stop (.*)".format(trg=trgg))
...
@register(outgoing=True, pattern="^\{trg}rmbotfilters (.*)".format(trg=trgg))
...
@register(outgoing=True, pattern="^\{trg}filters$".format(trg=trgg))
