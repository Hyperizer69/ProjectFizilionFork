...
""" a module for ocr reading. """

import os

import requests

from userbot import CMD_HELP, OCR_SPACE_API_KEY, TEMP_DOWNLOAD_DIRECTORY, bot, trgg
...
@register(pattern="^\{trg}ocr (.*)".format(trg=trgg), outgoing=True)
async def ocr(event):
